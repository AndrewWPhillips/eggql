...
func TestBuildSchema(t *testing.T) {
	testData := map[string]struct {
		...
		"IDReturn2": {data: struct{ Id eggql.ID }{}, expected: "type Query{ id: ID! }"},
		"IDReturn3": {data: struct{ Id *eggql.ID }{}, expected: "type Query{ id: ID }"},
		"IDList": {
			data: struct {
				Id []string `egg:":[ID!]!"`
			}{}, expected: "type Query{ id: [ID!]! }",
		},
		"IDList2": {data: struct{ Id []eggql.ID }{}, expected: "type Query{ id: [ID!]! }"},
		"IDList3": {data: struct{ Id []*eggql.ID }{}, expected: "type Query{ id: [ID]! }"},
		"IDPtrList": {
			data: struct {
				Id *[]string `egg:":[ID]"`
			}{}, expected: "type Query{ id: [ID] }",

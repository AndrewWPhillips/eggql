...
var testData = map[string]struct {
	...
	"All":             {`a, params(b:d=f,c:e=g)`, "a", []string{"b", "c"}, []string{"d", "e"}, []string{"f", "g"}, "", false},
	"NameOnly":        {`X`, "X", nil, nil, nil, "", false},
	"NameOnly2":       {`joe,`, "joe", nil, nil, nil, "", false},
	"NameNull":        {`joe,nullable`, "joe", nil, nil, nil, "", true},
	"Params0":         {`,params()`, "", []string{}, []string{}, []string{}, "", false},
	"Params1":         {`,params(a)`, "", []string{"a"}, []string{""}, []string{""}, "", false},
	"Params2":         {`,params(abc,d)`, "", []string{"abc", "d"}, []string{"", ""}, []string{"", ""}, "", false},
	"Params3":         {`,params(abc,"d e",f)`, "", []string{"abc", `"d e"`, "f"}, []string{"", "", ""}, []string{"", "", ""}, "", false},
	"ParamsSpaced":    {`,params( a , bcd , efg )`, "", []string{"a", "bcd", "efg"}, []string{"", "", ""}, []string{"", "", ""}, "", false},
	"Defaults1":       {`,params(one=1,2)`, "", []string{"one", "2"}, []string{"", ""}, []string{"1", ""}, "", false},
	"Defaults2":       {`,params(one=1,two="number two")`, "", []string{"one", "two"}, []string{"", ""}, []string{"1", `"number two"`}, "", false},
	"Defaults3":       {`,params(list=[1,2,4],obj={a:1, b:"two"})`, "", []string{"list", "obj"}, []string{"", ""}, []string{"[1,2,4]", `{a:1, b:"two"}`}, "", false},
	...
	"EnumParams":      {`,params(height, unit:Unit)`, "", []string{"height", "unit"}, []string{"", "Unit"}, []string{"", ""}, "", false},
	"EnumParams2":     {`,params(h, w, unit:Unit = FOOT)`, "", []string{"h", "w", "unit"}, []string{"", "", "Unit"}, []string{"", "", "FOOT"}, "", false},
}
